...
type hook func(kubeClient manifest.ExecClient, params UpgradeHookCommonParams) util.Errors
type hooks []hook
...
type UpgradeHookCommonParams struct {
	SourceVer                string
	TargetVer                string
...
func runUpgradeHooks(hml []hookVersionMapping, kubeClient manifest.ExecClient, hc *UpgradeHookCommonParams, dryRun bool) util.Errors {
...
// matches.
func checkHookListEntry(h hookVersionMapping, hc *UpgradeHookCommonParams) (bool, error) {
...
func checkInitCrdJobs(kubeClient manifest.ExecClient, params UpgradeHookCommonParams) util.Errors {
